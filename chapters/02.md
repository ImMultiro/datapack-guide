...
description: Data packs can be created using any text editor, such as *Notepad* or *Sublime Text*. However, it is much nicer to use software with proper syntax highlighting and custom file icons. In this chapter you will set up *Visual Studio Code* for work with Minecraft data packs by using specialised extensions made by other data pack developers. If you wish to use a different text editor, feel free to [skip](#up-next) this chapter.
layout: default
---

### Previous: [Chapter 1. Introduction](01.html)
...
![A popup saying "Visual Studio Code is required to install this extension"](../assets/images/vscode-required.png)
...
<a name="up-next"></a>
### Up next: [Chapter 3. Your First Data Pack](03.html)
